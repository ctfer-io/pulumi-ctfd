...
class HintArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] challenge_id: Challenge of the hint.
        :param pulumi.Input[_builtins.str] content: Content of the hint as displayed to the end-user.
        :param pulumi.Input[_builtins.int] cost: Cost of the hint, and if any specified, the end-user will consume its own (or team) points to get it.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] requirements: List of the other hints it depends on.
        :param pulumi.Input[_builtins.str] title: Title of the hint, displayed to end users before unlocking.
        """
...
@pulumi.type_token("ctfd:index/hint:Hint")
class Hint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            cost: Optional[pulumi.Input[_builtins.int]] = None,
            requirements: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            title: Optional[pulumi.Input[_builtins.str]] = None) -> 'Hint':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def requirements(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        List of the other hints it depends on.
        """
        return pulumi.get(self, "requirements")
