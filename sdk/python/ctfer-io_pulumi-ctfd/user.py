...
class UserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] email: Email of the user, may be used to verify the account.
        :param pulumi.Input[_builtins.str] password: Password of the user. Notice than during a CTF you may not want to update those to avoid defaulting user accesses.
        :param pulumi.Input[_builtins.str] affiliation: Affiliation to a team, company or agency.
        :param pulumi.Input[_builtins.bool] banned: Is true if the user is banned from the CTF.
        :param pulumi.Input[_builtins.str] bracket_id: The bracket id the user plays in.
        :param pulumi.Input[_builtins.str] country: Country the user represent or is native from.
        :param pulumi.Input[_builtins.bool] hidden: Is true if the user is hidden to the participants.
        :param pulumi.Input[_builtins.str] language: Language the user is fluent in.
        :param pulumi.Input[_builtins.str] name: Name or pseudo of the user.
        :param pulumi.Input[_builtins.str] type: Generic type for RBAC purposes.
        :param pulumi.Input[_builtins.bool] verified: Is true if the user has verified its account by email, or if set by an admin.
...
@pulumi.type_token("ctfd:index/user:User")
class User(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[_builtins.str]] = None,
            verified: Optional[pulumi.Input[_builtins.bool]] = None,
            website: Optional[pulumi.Input[_builtins.str]] = None) -> 'User':
        """
