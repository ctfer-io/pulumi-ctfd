...
class FileArgs:
    def __init__(__self__, *,
                 ...
                 contentb64: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a File resource.
        :param pulumi.Input[builtins.str] challenge_id: Challenge of the file.
        :param pulumi.Input[builtins.str] contentb64: Base 64 content of the file, perfectly fit the use-cases of complex binaries. You could provide it from the file-system using `filebase64("${path.module}/...")`.
        :param pulumi.Input[builtins.str] location: Location where the file is stored on the CTFd instance, for download purposes.
        :param pulumi.Input[builtins.str] name: Name of the file as displayed to end-users.
        """
    ...
    @property
    @pulumi.getter
    def contentb64(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @contentb64.setter
    def contentb64(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _FileState:
    def __init__(__self__, *,
                 ...
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 sha1sum: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] location: Location where the file is stored on the CTFd instance, for download purposes.
        :param pulumi.Input[builtins.str] name: Name of the file as displayed to end-users.
        :param pulumi.Input[builtins.str] sha1sum: The sha1 sum of the file.
        """
        if challenge_id is not None:
            pulumi.set(__self__, "challenge_id", challenge_id)
        if contentb64 is not None:
    ...
    @property
    @pulumi.getter
    def sha1sum(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @sha1sum.setter
    def sha1sum(self, value: Optional[pulumi.Input[builtins.str]]):
...
class File(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            location: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            sha1sum: Optional[pulumi.Input[builtins.str]] = None) -> 'File':
        """
    ...
    @property
    @pulumi.getter(name="challengeId")
    def challenge_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Challenge of the file.
        """
        return pulumi.get(self, "challenge_id")
    ...
    @property
    @pulumi.getter
    def contentb64(self) -> pulumi.Output[builtins.str]:
        """
        Base 64 content of the file, perfectly fit the use-cases of complex binaries. You could provide it from the file-system using `filebase64("${path.module}/...")`.
        """
        return pulumi.get(self, "contentb64")
    ...
    @property
    @pulumi.getter
    def sha1sum(self) -> pulumi.Output[builtins.str]:
        """
        The sha1 sum of the file.
        """
        return pulumi.get(self, "sha1sum")
