...
class TeamArgs:
    def __init__(__self__, *,
                 captain: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] members: List of members (User), defined by their IDs.
    ...
    @property
    @pulumi.getter
    def captain(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @captain.setter
    def captain(self, value: pulumi.Input[builtins.str]):
...
class _TeamState:
    ...
    @property
    @pulumi.getter
    def captain(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Member who is captain of the team. Must be part of the members too. Note it could cause a fatal error in case of resource import with an inconsistent CTFd configuration i.e. if a team has no captain yet (should not be possible).
        """
        return pulumi.get(self, "captain")
    ...
    @captain.setter
    def captain(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "captain", value)
...
class Team(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            password: Optional[pulumi.Input[builtins.str]] = None,
            website: Optional[pulumi.Input[builtins.str]] = None) -> 'Team':
        """
    ...
    @property
    @pulumi.getter
    def captain(self) -> pulumi.Output[builtins.str]:
        """
        Member who is captain of the team. Must be part of the members too. Note it could cause a fatal error in case of resource import with an inconsistent CTFd configuration i.e. if a team has no captain yet (should not be possible).
        """
        return pulumi.get(self, "captain")
