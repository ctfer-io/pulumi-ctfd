...
class ChallengeDynamicRequirementsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] behavior: Behavior if not unlocked, either hidden or anonymized.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] prerequisites: List of the challenges ID.
        """
