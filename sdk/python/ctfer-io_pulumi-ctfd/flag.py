...
class FlagArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] challenge_id: Challenge of the flag.
        :param pulumi.Input[_builtins.str] content: The actual flag to match. Consider using the convention `MYCTF{value}` with `MYCTF` being the shortcode of your event's name and `value` depending on each challenge.
        :param pulumi.Input[_builtins.str] data: The flag sensitivity information, either case*sensitive or case*insensitive
        :param pulumi.Input[_builtins.str] type: The type of the flag, could be either static or regex
        """
...
@pulumi.type_token("ctfd:index/flag:Flag")
class Flag(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            content: Optional[pulumi.Input[_builtins.str]] = None,
            data: Optional[pulumi.Input[_builtins.str]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None) -> 'Flag':
        """
