...
namespace CTFerio.Ctfd
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("CTFerio.Ctfd.version.txt");
    ...
    internal sealed class CtfdResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public CtfdResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
